...
am5.ready(function () {
    ...
    // Add labels
    let maleLabel = chart.plotContainer.children.push(am5.Label.new(root, {
        text: "Males",
        fontSize: 20,
        y: 5,
        x: 5,
        //centerX: am5.p50,
        fill: maleSeries.get("#50CD89"),
        // background: am5.RoundedRectangle.new(root, {
    ...
    let femaleLabel = chart.plotContainer.children.push(am5.Label.new(root, {
        text: "Females",
        fontSize: 20,
        y: 5,
        x: 200,
    ...
    // Create chart
    let map = container.children.push(
    ...
    // Title
    let title = map.children.push(am5.Label.new(root, {
        text: "آمریکا",
        fontSize: 20,
        y: 0,
        x: 150,
    ...
    //     let state = ev.target.dataItem.dataContext.id.split("-").pop();
